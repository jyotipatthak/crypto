...
const CryptoExchangeComparison = () => {
  ...
  return (
    <div className="container shadow-md border rounded-md bg-white h-64 top-2 relative mb-5">
      ...
      <div htmlFor="crypto1" className="relative left-2 top-6 font-bold text-orange-500">
        buy
      </div>
      <select
        id="crypto1"
      ...
      <div htmlFor="crypto2" className="relative top-8 font-bold text-teal-600 left-2">
        sell
      </div>
      <select
        id="crypto2"
      ...
      <button
        id="compare"
        className="relative top-4 right-9 left-9 shadow-md rounded-md border-solid bg-blue-400 border-radius h-9 w-28"
